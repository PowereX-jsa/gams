package com.gams.examples.warehouse;
...
/**
 * This example demonstrates how to solve a simple GAMS model to assign stores to 
 * warehouses for different data sets in parallel. The model has been parameterized. 
 * The data can be derived from a few numbers namely the number of warehouses, stores, 
 * and some fixed cost scalar. The results of the model are written into a single 
 * result database that is protected across the parallel threads via a mutex.
 */ 
public class Warehouse {
    ...
    public static void main(String[] args) {
        ...
        // create a directory
        File workingDirectory = new File(System.getProperty("user.dir"), "Warehouse");
